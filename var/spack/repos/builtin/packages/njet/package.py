...
class Njet(AutotoolsPackage):
    ...
    depends_on("qd@2.3.23:", when="@3.1.0:")
    depends_on("qd")
    ...
    patch(
        ...
        sha256="e0874ab30527c081163294dddfa3383252157d09247491e76e3ee1ed51828438",
        when="@:3.0.1",
    )
    patch(
        "njet-3.1.0-c++20.patch",
        sha256="c9aa7d1f2a6b20b590c618ccbff633d62ba2a5a8e5ec30ef9764aa84df0fd431",
        when="@3.1.0:"
    )
